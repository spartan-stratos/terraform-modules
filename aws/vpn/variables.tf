...
variable "self_service_saml_provider_arn" {
  description = "The ARN of the IAM Self Service SAML identity provider"
  type        = string
}
...
variable "enable_service_portal" {
  description = "Indicates whether service-portal is enabled on VPN endpoint"
  type        = string
  default     = "enabled"
}
