...
| <a name="input_overwrite_secret_manager_db_password_name"></a> [overwrite\_secret\_manager\_db\_password\_name](#input\_overwrite\_secret\_manager\_db\_password\_name) | Whether to overwrite secret name created in AWS Secret Manager.                                                         | `string`                                                                                   | `null`          |    no    |
...
| <a name="output_main_address"></a> [main\_address](#output\_main\_address)                                   | The address of the main instance                                                                    |
| <a name="output_replica_address"></a> [replica\_address](#output\_replica\_address)                          | The endpoint of the first replica, fallback to the endpoint of main instance if there is no replica |
