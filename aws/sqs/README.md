...
| <a name="input_read_policy_name_prefix"></a> [read\_policy\_name\_prefix](#input\_read\_policy\_name\_prefix) | The name of the custom read policy | `string` | `"SQSRead"` | no |
...
| <a name="input_write_policy_name_prefix"></a> [write\_policy\_name\_prefix](#input\_write\_policy\_name\_prefix) | The name of the custom write policy | `string` | `"SQSWrite"` | no |
