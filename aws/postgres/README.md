...
| <a name="input_whitelisted_db_access_cidrs"></a> [whitelisted_db_access_cidrs](#input\_whitelisted\_db\_access\_cidrs)                                           | List of CIDR blocks representing the IP ranges that are permitted to access the database.                                                                                                                                                                                                  | `list(string)` | `[]`                          |    no    |
