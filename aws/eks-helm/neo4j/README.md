...
| <a name="input_neo4j_plugins"></a> [neo4j\_plugins](#input\_neo4j\_plugins)                                | A list of URLs pointing to the Neo4J plugins to be installed.                                                                                        | `list(string)` | <pre>[<br/>  "https://github.com/neo4j/graph-data-science/releases/download/2.13.2/neo4j-graph-data-science-2.13.2.jar",<br/>  "https://github.com/neo4j/apoc/releases/download/5.26.0/apoc-5.26.0-core.jar"<br/>]</pre> |    no    |
