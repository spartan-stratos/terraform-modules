...
| <a name="input_github_org_display_name"></a> [github\_org\_display\_name](#input\_github\_org\_display\_name) | The Github org display name. There should be no whitespaces within. | `string` | `"Spartan"` | no |
