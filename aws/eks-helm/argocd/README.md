...
| <a name="input_github_app"></a> [github\_app](#input\_github\_app) | GitHub App configuration to use for Argo CD | <pre>object({<br/>    name     = string<br/>    id           = number<br/>    private_key  = string<br/>    organization = string<br/>  })</pre> | n/a | yes |
