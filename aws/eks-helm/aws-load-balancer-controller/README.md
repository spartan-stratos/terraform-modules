...
| <a name="input_external_default_service"></a> [external\_default\_service](#input\_external\_default\_service)                                                             | Default service for the ingress controller                             | <pre>object({<br/>    name      = string<br/>    port      = number<br/>  })</pre>                                                                             | `null`                                  |    no    |
