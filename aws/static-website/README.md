...
- Static Website Redirect — If `s3_redirect_domain` is set, the S3 bucket is configured to redirect all requests to the specified domain `s3_redirect_domain`.
...
- [S3 static website](./examples/complete/)
- [S3 redirect to another domain](./examples/s3-redirect/)
